...
function add_1(a : number,b : number) {
    return a+b;
}
...
// beow code is wrong, optional arguments can't come before the requirement.
...
// even optional arguments can be Typed
function add_7(a,b,c = 0, d?:number) {

}

// if need to get rid of '?' for 'd' then
function add_8(a,b,c = 0, d: number = 0) {

}

// we can specify return type also
function add_9(a,b,c = 0, d: number = 0) : number {
    return a + b + c + d
}
// we have achived type safety for both input arguments and return type
